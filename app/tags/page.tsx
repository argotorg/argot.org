...
export default async function Page() {
  ...
  return (
    <>
      <div className="flex flex-col items-start justify-start divide-y divide-ecru dark:divide-anthracite md:mt-24 md:flex-row md:items-center md:justify-center md:space-x-6 md:divide-y-0">
