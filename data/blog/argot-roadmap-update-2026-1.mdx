...
### Q3/Q4 2025 review
**Milestones completed**
* **4byte service and database:** Took over openchain.xyz's 4byte signature service. Built the largest Ethereum signature database (7.5 million signatures) by consolidating the openchain, 4byte.directory, [etherface](https://github.com/volsa/etherface/) data, and streaming Sourcify verified contract signatures. The service serves 7 million requests per day. 
