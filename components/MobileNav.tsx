        ...
        {headerNavLinks.map((link) =>
          link.title === 'Home' ? null : (
            <Link
              key={link.title}
              href={link.href}
              className="py-2 text-base font-bold tracking-widest text-gray-900 outline outline-0 hover:text-primary-500 dark:text-gray-100 dark:hover:text-primary-400"
              onClick={onToggleNav}
            >
              {link.title}
            </Link>
